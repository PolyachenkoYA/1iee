...
rho = [1.23, 1.75, 2.01, 1.78]';
rho = [1.55, 1.89, 2.08, 2.16, 2.58, 2.58]';
...
d_rho = [0.04, 0.15, 0.05, 0.15]';
d_rho = [0.03, 0.03, 0.03, 0.03, 0.05, 0.05]';
...
if(do_rho)
    ...
    plot(fig_rho_Kfit.ax, Kfit_x, (Kfit_x - 0.246) * Kfit_lin(1)*190/1290 + 0.971, 'DisplayName', ['K = 190 MPa'])
