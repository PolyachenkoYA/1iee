...
extra_waters = [-1000, -950, -900, -850, -800, -750, -700, -650, -600, -550]
#extra_waters = [-40, 110]
...
for i in range(len(extra_waters)):
        #my.run_it('python water_density_full.py -temp 35 -extra_water ' + str(extra_waters[i]) + ' -comprZ 0 -save_pics 1 -avg_time 10 -Zstep 1')
