...
$gmx_executable trjconv -s nvt.tpr -f nvt.gro -pbc nojump -o nvt_nojump.gro < output_whole_sys0.in
...
#$gmx_executable trjconv -s npt.tpr -f npt.gro -pbc nojump -o npt_nojump.gro < output_whole_sys0.in
...
#$gmx_executable trjconv -s md_mainrun.tpr -f md_mainrun.gro -pbc nojump -o md_mainrun_nojump.gro < output_whole_sys0.in
