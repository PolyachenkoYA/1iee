...
root_path = sp.run(['/usr/bin/git', 'rev-parse', '--show-toplevel'], stdout=sp.PIPE, text=True).stdout[:-1]  # -1 to cut the '\n'
#root_path = '/mnt/storage/home/polyachenkoya/1iee'
